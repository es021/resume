export default {
    ...
    body: {
        ...
        experience: [{
            ...
            //     detail: "Working with team members to design and develop highway in all aspects (speed limit, vertical and horizontal curve, etc). Responsible inhandling all software related processes to work onthe design for the team."
            // }
        ],
        socialMedia: [{
            icon: "linkedin-in",
